...
public record PeliculaOut(Long id, String titulo, String sinopsis, String precio, String condicion, String genero, List<DirectorOut> directores, List<ActorOut> actores) {
    ...
    public static PeliculaOut fromModel(Pelicula p){
        ...
        return new PeliculaOut(p.getId(), p.getTitulo(), p.getSinopsis(), precio, condicion, genero, directores, actores);
    }
}
